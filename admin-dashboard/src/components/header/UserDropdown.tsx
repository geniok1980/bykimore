  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Имя пользователя */}
        <span className="block mr-1 font-medium text-theme-sm">{user ? user.username : '...'}</span>
